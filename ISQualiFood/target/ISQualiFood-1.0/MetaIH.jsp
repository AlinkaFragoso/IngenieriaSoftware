<%-- 
    Document   : MetaIH
    Created on : 14/04/2017, 09:31:12 PM
    Author     : giss_
--%>
            ...
            <div class="container">
                ...
                <nav class="navbar navbar-default">
                    ...
                    <div class="welcome">
                        ...
                        <div class="container">
                            <h1 class="w3ls_head">Nuestra meta</h1>
                            <p class="w3layouts_para">¿Qué es Quali-Food? Quali-Food 
                                es un software creado para ti. Porque pensamos en 
                                la incomodidad que representa no saber en dónde y qué comer, 
                                hemos decidido crear la aplicación que te recomendará
                                lo mejor en alimentos dentro de la Facultaad de ciencias. 
                                Así podrás conocer y compartir experiencias con compañeros 
                                de la facultad con unos sencillos pasos. 
                            </p>
