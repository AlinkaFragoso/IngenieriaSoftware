                    ...
                    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                        <nav class="menu menu--iris">
                            <ul class="nav navbar-nav menu__list">
                                <li class="menu__item"><a href="IndexIH.jsp" class="menu__link">Inicio</a></li>
                                <li class="menu__item menu__item--current"><a href="RegistroUsuarioIH.jsp" class="menu__link">Regístrate</a></li>
