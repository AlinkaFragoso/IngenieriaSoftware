<%-- 
    Document   : ContactoIH
    Created on : 14/04/2017, 09:34:40 PM
    Author     : giss_
--%>
...
-->                    <div class="welcome">
                        ...
                        <img src="./images/escudounam.png" width="20%" height="20%" alt="Universidad Nacional Autónoma de México" align="right"></img>
                            ...
                            <div class="contact">
                                <div class="container">
                                    <h1 class="w3ls_head">Contáctanos</h1>
                                    <p class="w3layouts_para">Si tienes dudad o comentarios, 
                                        puedes escribirnos. </p>
                                    <center><p> Déjanos tu mensaje, o envía un correo electrónico a 
                                            la dirección qualifood@vatunisaa.com </p> </center>
