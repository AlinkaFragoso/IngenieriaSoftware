<%-- 
    Document   : AcercaDeIH
    Created on : 14/04/2017, 09:38:18 PM
    Author     : giss_
--%>
                ...
                <div class="agile-header">
                    ...
                    <div class="w3_agileits_social_media">
                        <ul>
                            ...
                            <li><a link href="https://www.facebook.com/" class="wthree_facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                            <li><a link href="https://www.facebook.com/" class="wthree_twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
...
<!--                    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    ...
                    <div class="welcome">
                        ...
                        <div class="container">
                            <h1 class="w3ls_head">¿Quiénes somos?</h1>
                            <p class="w3layouts_para">Vatuni Saa Software, es un 
                                equipo de desarrolladores, integrado por estudiantes 
                                de la Facultad de Ciencias de la Universidad Nacional 
                                Autónoma de México fundado en 2017. Fue creado inicialmente 
                                para la realización del proyecto Quali-Food. </p>
